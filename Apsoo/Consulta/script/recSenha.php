	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				...
				Um email para a recuperacao de senha<br>
            foi enviado para <?php print $email_rec?>
            
             <br /> <br />
	Redirecionamento automaticamento para pagina de login. 
